<?php
  ...
  if (isset($_POST['upload'])) {
    ...
    $dname = mysqli_real_escape_string($db, $_POST['mname']);
  	$image_text = mysqli_real_escape_string($db, $_POST['text']);
    $mprice = mysqli_real_escape_string($db, $_POST['mprice']);

  	$sql = "INSERT INTO medicine (mimage , mname , mdescription, mprice) VALUES ('$image', '$dname' ,'$image_text','$mprice')";
  	mysqli_query($db, $sql);
        ...
        <div class="row">
            <div class="col-sm-2">
                ...
                <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a style="color: #63637a;font-family: serif;font-size: 13px;" class="nav-link" href="doctor.php"><i class="fas fa-video fa-1x"></i>&nbsp;&nbsp;ADD DOCTORS</a>
                        </li>
                        <li class="nav-item active">
                            <a style="color: #c8ced6;font-family: serif;font-size: 13px;" class="nav-link" href="medicine.php"><i class="fab fa-dashcube fa-1x"></i></i>&nbsp;&nbsp;ADD MEDICINES <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
            ...
            <div style="background-color:#babbbf;" class="col-sm-10">
                   ...
                   <div class="row">
                        <div class="col-sm-12 d-flex justify-content-center">
                            <div class="card" style="width: 55rem;height: 22rem;background-color: #38434d;">
                                    <div class="card-body">
                                        <p style="color: #c8ced6;font-size:16px;" class="text-center">Upload Our Medicines List</p>
                                        <form method="POST" action="medicine.php" enctype="multipart/form-data">
                                            <input type="hidden" name="size" value="1000000">
                                                <div>
                                                    <input style="color: #c8ced6" type="file" name="image">
                                                    <br> <input style="color: #c8ced6" type="text" name="mname" placeholder="Medicine Name">
                                                    <br> <textarea id="text" cols="80" rows="5" name="text" placeholder="Medicine Description Here..."></textarea>                                                  
                                                    <br> <input style="color: #c8ced6" type="text" name="mprice" placeholder="Medicine Price">
                            ...
                            <h3>view Medicines</h3>
                                    <?php
                                        while ($row = mysqli_fetch_array($result)) {
                                            echo "<div id='img_div'>";
                                                echo "<img src='images/".$row['mimage']."'>";
                                                echo "<p id='para1'>medicine name :".$row['mname']."</p>";
                                                echo "<p id='para1'>medicine description :".$row['mdescription']."</p>";
                                                echo "<p id='para1'>medicine price :".$row['mprice']."</p>";
                                            echo "</div>";
                                        }
                                    ?>     
