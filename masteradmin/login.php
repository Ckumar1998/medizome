...
<style>
  body{
    background-image: url(images/benoumechiaravymen-a3qFQMQtBnQ-unsplash.jpg);
    width: 100%;
  }
  a{
    color: #fff;
            ...
            <div class="col-sm-8">
              ...
              <div class="card" style="width: 40rem;background: transparent;border-color: #fff;">
                ...
                <h3 style="color: #fff;" class="text-center">Login</h3>  
                    <form method="POST" action="login.php" enctype="multipart/form-data" style="border: 1px solid #7f7f7f;border-radius: 5px;width: 90%;margin: 30px;margin-top: 10px;margin-bottom: 20px;">  
                        <br>                  
