            ...
            <div style="background-color: #babbbf;" class="col-sm-2">
                ...
                <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active">
                            <a style="color: #c8ced6;font-family: serif;font-size: 13px;" class="nav-link" href="user.php"><i class="fab fa-dashcube fa-1x"></i></i>&nbsp;&nbsp;USERS<span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                       ...
                       <h3>view Users</h3>
                            <?php
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<p id='para1'>User Id :".$row['uid']."</p>";
                                    echo "<p id='para1'>Name :".$row['name']."</p>";
                                    echo "<p id='para1'>Adress :".$row['address']."</p>";
                                    echo "<p id='para1'>Phone Number :".$row['number']."</p>";
                                    echo "<p id='para1'>Place :".$row['place']."</p>";
                                    echo "<p id='para1'>Username :".$row['username']."</p>";
                                    echo "<p id='para1'>Password :".$row['password']."</p>";
                                    echo "</div>";
                                }
                            ?>         
