<?php
  ...
  if (isset($_POST['login2'])) {
    ...
    $res23 = mysqli_query($db, "SELECT * FROM hospreg");
    ...
    $sql1 = "INSERT INTO login (hid , username , password) VALUES ( '$id2' ,'$usename' , '$pass')";
            ...
            <div class="col-sm-8 d-flex justify-content-center">
              <div class="card" style="width: 40rem;background: transparent;border-color: #fff;">
                <div style="background-color: #babbbf;" class="card-body">
                  ...
                  <br>
                    <form method="POST" action="hosreg.php" enctype="multipart/form-data" style="border: 1px solid #7f7f7f;border-radius: 5px;width: 90%;margin: 30px;margin-top: 10px;margin-bottom: 20px;background-color: #929397;">  
                        <br>
                        <h3 style="color: #fff;" class="text-center">Hospital Registration</h3>                    
                        <div class="form-group d-flex justify-content-center">
                        <label  for="exampleInputEmail1">Hospital Name</label>
                        <input style="width: 300px;color: #fff;background-color: transparent;" name="name1" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                        </div>
                        <div class="form-group d-flex justify-content-center">
                        <label  for="exampleInputEmail1">Hospital Address</label>
                        <textarea style="background: transparent;color: #fff;" name="address1" id="" cols="40" rows="4"></textarea>
                        </div>
                        <div class="form-group d-flex justify-content-center">
                        <label  for="exampleInputEmail1">Hospital Number</label>
                        <input style="width: 300px;color: #fff;background-color: transparent;" name="number1" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                        </div>
                        <div class="form-group d-flex justify-content-center">
                        <label  for="exampleInputEmail1">Place</label>
                        <input style="width: 300px;color: #fff;background-color: transparent;" name="place1" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                        </div>
                        <div class="form-group d-flex justify-content-center">
